                                    ...
                                    <div class="fileM-grid-wrapper mb-30">
                                        <div class="fileM-wrapper mb-25">
                                            <div class="fileM-top-search">
                                                ...
                                                <div
                                                    class="project-icon-selected"
                                                >
                                                    <div
                                                        class="listing-social-link pb-lg-0 pb-xs-2"
                                                    >
                                                        <div
                                                            class="icon-list-social d-flex"
                                                        >
                                                            <a
                                                                ...
                                                                <td>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <span
                                                                                class="color-light fs-12 d-flex"
                                                                            >
                                                                                {{
                                                                                    file.type.split(
                                                                                        "/"
    ...
    methods: {
        ...
        async fetchDirectory() {
            ...
            this.filesystem = this.buildFilesystem(
                folders.items.filter((x) => x.parentFolderId == null),
                folders.items.filter((x) => x.parentFolderId != null),
                files.items
            );
        },
        buildFilesystem(rootFolders, folders, files) {
            ...
            return rootFolders.map((rootFolder) =>
                folderMap.get(rootFolder.id)
            );
        },
        switchDirectory(folder_id) {
            console.log("switched to ", folder_id);
            this.active_folder = findFolder(folder_id, filesystem);
        },
